...
#define chipSelect      5     // SPI/SD Card Chip Select Digital Pin 5
#define ERROR_LED       16
// Red LED Connected to Digital Pin 4
#define LOG_STATUS_LED  4    // Green LED Connected to Digital Pin 16
#define SD_INSERTED_PIN 17    // CD Pin Connected to Digital Pin 17
#define LOG_SWITCH_PIN  0     // Momentary Switch Connected to Digital Pin 0
